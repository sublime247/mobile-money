-- Migration: 011_add_vaults
-- Description: Create vaults and vault_transactions tables, add vault_id to transactions
-- Source: database/migrations/add_vaults_table.sql
