...
if (fs.existsSync(webhookServicePath)) {
  ...
  if (
    serviceContent.includes("FlatWebhookPayload") &&
    serviceContent.includes("buildFlatPayload")
  ) {
...
const webhookTestPath = path.join(
  __dirname,
  "src/routes/__tests__/webhooks.test.ts",
);
const webhookServiceTestPath = path.join(
  __dirname,
  "src/services/__tests__/webhook-flat.test.ts",
);
...
if (fs.existsSync(indexPath)) {
  ...
  if (
    indexContent.includes("webhookRoutes") &&
    indexContent.includes("/api/webhooks")
  ) {
