...
import { adminGeofenceMiddleware } from "./services/geolocation";
...
app.use("/api/admin/assets", adminGeofenceMiddleware, adminAssetRoutes);
...
app.use("/api/admin", requireAuth, adminGeofenceMiddleware, adminRoutes);
app.use("/api/admin/providers/status", requireAuth, adminGeofenceMiddleware, providerStatusRouter);
app.use("/api/admin/kyc-upgrades", requireAuth, adminGeofenceMiddleware, kycTierUpgradeRoutes);
app.use("/api/admin/auth", adminGeofenceMiddleware, createAdminSep10Router());
