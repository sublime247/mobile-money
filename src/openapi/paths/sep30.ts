...
const KEY_ID_PARAM = z.object({
  keyId: z.string().uuid().openapi({ example: "key-uuid-here" }),
});
const SESSION_PARAM = z.object({
  sessionId: z.string().uuid().openapi({ example: "session-uuid-here" }),
});
...
registry.registerPath({
  ...
  request: {
    body: {
      required: true,
      content: { "application/json": { schema: CreateKeyRequestSchema } },
    },
  },
  responses: {
    201: {
      description: "Key created",
      content: { "application/json": { schema: ManagedKeySchema } },
    },
    400: {
  ...
  responses: {
    200: {
      ...
      content: {
        "application/json": {
          schema: z
            .object({ keys: z.array(ManagedKeySchema) })
            .openapi("Sep30KeyList"),
        },
      },
    },
    400: {
      ...
      content: {
        "application/json": {
          schema: z
            ...
            .openapi("Sep30ThresholdResponse"),
        },
      },
    },
    400: {
...
registry.registerPath({
  ...
  responses: {
    201: {
      description: "Signer registered",
      content: { "application/json": { schema: RecoverySignerSchema } },
    },
    400: {
      description: "Invalid key or validation error",
      content: { "application/json": { schema: ErrorResponseSchema } },
    },
  },
});
  ...
  responses: {
    200: {
      ...
      content: {
        "application/json": {
          schema: z
            .object({ signers: z.array(RecoverySignerSchema) })
            .openapi("Sep30SignerList"),
        },
      },
    },
  },
...
registry.registerPath({
  ...
  request: {
    ...
    body: {
      required: true,
      content: { "application/json": { schema: OpenSessionRequestSchema } },
    },
  },
  responses: {
    201: {
    ...
    400: {
      description: "Active session already exists or validation error",
      content: { "application/json": { schema: ErrorResponseSchema } },
    },
  },
});
...
registry.registerPath({
          ...
          schema: z
            .object({
              ...
              sessionId: z.string().uuid().optional().openapi({
                description:
                  "ID from /session. Required for multi-signer flows.",
              }),
            })
  ...
  responses: {
          ...
          schema: z
            .object({
              token: z.string().openapi({
                description:
                  "Raw hex token to sign with your Stellar private key.",
              }),
    ...
    400: {
      description: "Signer not registered",
      content: { "application/json": { schema: ErrorResponseSchema } },
    },
  },
});
...
registry.registerPath({
  ...
  responses: {
    ...
    400: {
      description: "Invalid signature or session state",
      content: { "application/json": { schema: ErrorResponseSchema } },
    },
    401: {
...
registry.registerPath({
  ...
  responses: {
    ...
    400: {
      description: "Session not in awaiting_completion state",
      content: { "application/json": { schema: ErrorResponseSchema } },
    },
    410: {
          ...
          schema: z
            .object({
              ...
              reason: z
                .string()
                .optional()
                .openapi({ example: "User cancelled" }),
            })
  ...
  responses: {
    200: {
      ...
      content: {
        "application/json": {
          schema: z
            .object({ message: z.string(), sessionId: z.string() })
            .openapi("Sep30CancelResponse"),
        },
      },
    },
    400: {
  ...
  responses: {
    200: {
      ...
      content: {
        "application/json": {
          schema: z
            .object({ sessions: z.array(RecoverySessionSchema) })
            .openapi("Sep30SessionList"),
        },
      },
    },
  },
...
registry.registerPath({
  ...
  responses: {
    200: {
      ...
      content: { "application/json": { schema: RecoverySessionSchema } },
    },
    404: {
...
registry.registerPath({
  ...
  description:
    "Returns every state transition, signer approval, and metadata event.",
  request: { params: KEY_ID_PARAM.merge(SESSION_PARAM) },
  responses: {
    200: {
      ...
      content: {
        "application/json": {
          schema: z
            .object({
              sessionId: z.string().uuid(),
              log: z.array(AuditLogEntrySchema),
            })
