  ...
  request: {
    query: z.object({
      ...
      before: z
        .string()
        .optional()
        .openapi({ description: "Cursor for backward pagination" }),
      after: z
        .string()
        .optional()
        .openapi({ description: "Cursor for forward pagination" }),
    }),
  },
  responses: {
    200: {
...
registry.registerPath({
  ...
  request: {
    ...
    query: z.object({
      download: z.string().optional().openapi({
        description: "Set to 0 to display inline instead of downloading",
      }),
    }),
  },
  responses: {
    ...
    400: {
      description: "Invoice download only available for completed transactions",
      content: { "application/json": { schema: ErrorResponseSchema } },
    },
    401: {
      description: "Unauthorized",
...
registry.registerPath({
  ...
  request: {
    ...
    body: {
      content: {
        "application/json": { schema: DeleteMetadataKeysRequestSchema },
      },
      required: true,
    },
  },
