  ...
  z
    .object({
      ...
      price: z.string().openapi({
        example: "650.1234567",
        description: "Units of buy_asset per 1 unit of sell_asset.",
      }),
      fee_percent: z.string().openapi({
        example: "0.50",
        description: "Percentage fee applied to this conversion.",
      }),
      fee_fixed: z.string().openapi({
        example: "0.0000000",
        description: "Fixed fee in sell_asset units.",
      }),
    })
    ...
    .object({
      ...
      sell_amount: z
        ...
        .openapi({
          example: "10000",
          description:
            "Amount to sell. Provide exactly one of sell_amount or buy_amount.",
        }),
      buy_amount: z
        .string()
        ...
        .openapi({
          example: "15.3000000",
          description:
            "Amount to receive. Provide exactly one of sell_amount or buy_amount.",
        }),
      ttl: z.number().int().positive().max(300).optional().openapi({
        example: 60,
        description: "Quote lifetime in seconds (1–300). Defaults to 60.",
      }),
    })
  ...
  z
    .object({
      ...
      expires_at: z
        .string()
        .datetime()
        .openapi({ example: "2024-04-25T10:01:00.000Z" }),
      sell_asset: Sep38AssetSchema,
      buy_asset: Sep38AssetSchema,
