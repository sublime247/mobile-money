...
const mockedSubModel = subscriptionModel as jest.Mocked<
  typeof subscriptionModel
>;
const mockedAddJob = addTransactionJob as jest.MockedFunction<
  typeof addTransactionJob
>;
...
describe("runSubscriptionJob", () => {
  ...
  test("creates transaction and enqueues job for due subscription", async () => {
    ...
    mockedSubModel.recordAttempt = jest
      .fn()
    ...
    expect(mockedSubModel.recordAttempt).toHaveBeenCalledWith(
      "sub1",
      "tx1",
      1,
      "pending",
