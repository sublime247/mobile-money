...
var OrangeProvider = /** @class */ (function () {
  function OrangeProvider(options) {
    ...
    this.client =
      (_b = options.httpClient) !== null && _b !== void 0
        ? _b
    ...
    this.directClient =
      (_c = options.directHttpClient) !== null && _c !== void 0
        ? _c
        : axios_1.default.create({
    ...
    if (this.config.proxyBaseUrl) {
      this.proxyClient =
        (_d = options.proxyHttpClient) !== null && _d !== void 0
          ? _d
          : axios_1.default.create({
  ...
  OrangeProvider.prototype.requestPayment = function (phoneNumber, amount) {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        return [
          2 /*return*/,
          this.executeOperation("payment", phoneNumber, String(amount)),
        ];
      });
    });
  };
  OrangeProvider.prototype.sendPayout = function (phoneNumber, amount) {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        return [
          2 /*return*/,
          this.executeOperation("payout", phoneNumber, String(amount)),
        ];
      });
    });
  };
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.sendRequest(this.proxyClient, {
                method: "GET",
          ...
          case 6:
            ...
            return [
              2 /*return*/,
              { success: false, error: error_1, reference: reference },
            ];
          case 7:
            return [2 /*return*/];
        }
    ...
    return {
      mode:
        (_a = options.mode) !== null && _a !== void 0
          ? _a
          : process.env.ORANGE_MODE,
      webBaseUrl:
        (_d =
          (_c =
            (_b = options.webBaseUrl) !== null && _b !== void 0
              ? _b
              : options.baseUrl) !== null && _c !== void 0
            ? _c
            : process.env.ORANGE_WEB_BASE_URL) !== null && _d !== void 0
          ? _d
          : "",
      directBaseUrl:
        (_g =
          (_f =
            (_e = options.directBaseUrl) !== null && _e !== void 0
              ? _e
              : options.baseUrl) !== null && _f !== void 0
            ? _f
            : process.env.ORANGE_BASE_URL) !== null && _g !== void 0
          ? _g
          : "https://sandbox.orange.com",
      loginPath:
        (_j =
          (_h = options.loginPath) !== null && _h !== void 0
            ? _h
            : process.env.ORANGE_LOGIN_PATH) !== null && _j !== void 0
          ? _j
          : "/login",
      refreshPath:
        (_l =
          (_k = options.refreshPath) !== null && _k !== void 0
            ? _k
            : process.env.ORANGE_REFRESH_PATH) !== null && _l !== void 0
          ? _l
          : "/session/refresh",
      paymentPath:
        (_o =
          (_m = options.paymentPath) !== null && _m !== void 0
            ? _m
            : process.env.ORANGE_PAYMENT_PATH) !== null && _o !== void 0
          ? _o
          : "/transactions/collections",
      payoutPath:
        (_q =
          (_p = options.payoutPath) !== null && _p !== void 0
            ? _p
            : process.env.ORANGE_PAYOUT_PATH) !== null && _q !== void 0
          ? _q
          : "/transactions/payouts",
      statusPath:
        (_s =
          (_r = options.statusPath) !== null && _r !== void 0
            ? _r
            : process.env.ORANGE_STATUS_PATH) !== null && _s !== void 0
          ? _s
          : "/transactions/:reference",
      directAuthPath:
        (_u =
          (_t = options.directAuthPath) !== null && _t !== void 0
            ? _t
            : process.env.ORANGE_DIRECT_AUTH_PATH) !== null && _u !== void 0
          ? _u
          : "/oauth/token",
      directPaymentPath:
        (_w =
          (_v = options.directPaymentPath) !== null && _v !== void 0
            ? _v
            : process.env.ORANGE_DIRECT_PAYMENT_PATH) !== null && _w !== void 0
          ? _w
          : "/v1/payments/collect",
      directPayoutPath:
        (_y =
          (_x = options.directPayoutPath) !== null && _x !== void 0
            ? _x
            : process.env.ORANGE_DIRECT_PAYOUT_PATH) !== null && _y !== void 0
          ? _y
          : "/v1/payments/disburse",
      directStatusPath:
        (_0 =
          (_z = options.directStatusPath) !== null && _z !== void 0
            ? _z
            : process.env.ORANGE_DIRECT_STATUS_PATH) !== null && _0 !== void 0
          ? _0
          : "/v1/payments/:reference",
      username:
        (_3 =
          (_2 =
            (_1 = options.username) !== null && _1 !== void 0
              ? _1
              : process.env.ORANGE_USERNAME) !== null && _2 !== void 0
            ? _2
            : process.env.ORANGE_API_KEY) !== null && _3 !== void 0
          ? _3
          : "",
      password:
        (_6 =
          (_5 =
            (_4 = options.password) !== null && _4 !== void 0
              ? _4
              : process.env.ORANGE_PASSWORD) !== null && _5 !== void 0
            ? _5
            : process.env.ORANGE_API_SECRET) !== null && _6 !== void 0
          ? _6
          : "",
      apiKey:
        (_8 =
          (_7 = options.apiKey) !== null && _7 !== void 0
            ? _7
            : process.env.ORANGE_API_KEY) !== null && _8 !== void 0
          ? _8
          : "",
      apiSecret:
        (_10 =
          (_9 = options.apiSecret) !== null && _9 !== void 0
            ? _9
            : process.env.ORANGE_API_SECRET) !== null && _10 !== void 0
          ? _10
          : "",
      usernameField:
        (_12 =
          (_11 = options.usernameField) !== null && _11 !== void 0
            ? _11
            : process.env.ORANGE_USERNAME_FIELD) !== null && _12 !== void 0
          ? _12
          : "username",
      passwordField:
        (_14 =
          (_13 = options.passwordField) !== null && _13 !== void 0
            ? _13
            : process.env.ORANGE_PASSWORD_FIELD) !== null && _14 !== void 0
          ? _14
          : "password",
      csrfField:
        (_16 =
          (_15 = options.csrfField) !== null && _15 !== void 0
            ? _15
            : process.env.ORANGE_CSRF_FIELD) !== null && _16 !== void 0
          ? _16
          : "_csrf",
      currency:
        (_18 =
          (_17 = options.currency) !== null && _17 !== void 0
            ? _17
            : process.env.ORANGE_CURRENCY) !== null && _18 !== void 0
          ? _18
          : "XAF",
      sessionStorePath:
        (_19 = options.sessionStorePath) !== null && _19 !== void 0
          ? _19
          : process.env.ORANGE_SESSION_STORE_PATH,
      sessionTtlMs: Number(
        (_21 =
          (_20 = options.sessionTtlMs) !== null && _20 !== void 0
            ? _20
            : process.env.ORANGE_SESSION_TTL_MS) !== null && _21 !== void 0
          ? _21
          : DEFAULT_SESSION_TTL_MS,
      ),
      refreshSkewMs: Number(
        (_23 =
          (_22 = options.refreshSkewMs) !== null && _22 !== void 0
            ? _22
            : process.env.ORANGE_REFRESH_SKEW_MS) !== null && _23 !== void 0
          ? _23
          : DEFAULT_REFRESH_SKEW_MS,
      ),
      requestTimeoutMs: Number(
        (_25 =
          (_24 = options.requestTimeoutMs) !== null && _24 !== void 0
            ? _24
            : process.env.ORANGE_REQUEST_TIMEOUT_MS) !== null && _25 !== void 0
          ? _25
          : 30000,
      ),
      maxAttempts: Number(
        (_27 =
          (_26 = options.maxAttempts) !== null && _26 !== void 0
            ? _26
            : process.env.ORANGE_MAX_ATTEMPTS) !== null && _27 !== void 0
          ? _27
          : 3,
      ),
      proxyBaseUrl:
        (_28 = options.proxyBaseUrl) !== null && _28 !== void 0
          ? _28
          : process.env.ORANGE_PROXY_URL,
      proxySecret:
        (_29 = options.proxySecret) !== null && _29 !== void 0
          ? _29
          : process.env.ORANGE_PROXY_SECRET,
    };
  };
  OrangeProvider.prototype.sendRequest = function (client, request) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        ...
        method = (
          (_a = request.method) !== null && _a !== void 0 ? _a : "GET"
        ).toUpperCase();
        url = request.url;
        if (!url) {
          throw new Error("Orange request URL is required");
        }
        config = __assign(__assign({}, request), {
          timeout:
  ...
  OrangeProvider.prototype.executeOperation = function (
    operation,
    phoneNumber,
    amount,
  ) {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.executeViaProxy(operation, phoneNumber, amount),
            ];
          case 1:
          ...
          case 2:
            ...
            return [
              4 /*yield*/,
              this.executeViaDirectApi(operation, phoneNumber, amount),
            ];
          case 3:
            return [2 /*return*/, _a.sent()];
          case 4:
  ...
  OrangeProvider.prototype.executeViaProxy = function (
    operation,
    phoneNumber,
    amount,
  ) {
  ...
  OrangeProvider.prototype.executeViaDirectApi = function (
    operation,
    phoneNumber,
    amount,
  ) {
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            return [
              ...
              this.sendRequest(
                ...
                __assign(__assign({}, request), {
                  headers: __assign(__assign({}, requestHeaders), {
                    Authorization: "Bearer ".concat(token),
                    "Content-Type":
                      (_b = requestHeaders["Content-Type"]) !== null &&
                      _b !== void 0
                        ? _b
                        : "application/json",
                  }),
          ...
          case 10:
            ...
            throw lastError !== null && lastError !== void 0
              ? lastError
              : new Error("Orange direct API request failed");
        }
      });
    });
  };
        ...
        switch (_b.label) {
            ...
            authHeader =
              ...
              Buffer.from(
                ""
                  ...
                  .concat(this.config.apiSecret),
              ).toString("base64");
            return [
              4 /*yield*/,
              this.sendRequest(this.directClient, {
                method: "POST",
          ...
          case 1:
            ...
            if (response.status < 200 || response.status >= 300) {
              throw new Error(
                "Orange direct auth failed with status ".concat(
                  response.status,
                ),
              );
            }
            ...
            this.apiTokenExpiry =
              this.clock() +
              ((_a = data.expires_in) !== null && _a !== void 0 ? _a : 3600) *
                1000 -
              5000;
            return [2 /*return*/, this.apiToken];
        }
      ...
      return __generator(this, function (_d) {
        switch (_d.label) {
              ...
              this.sendRequest(
                ...
                __assign(__assign({}, request), {
                  headers: __assign(__assign({}, requestHeaders), {
                    ...
                    "X-CSRF-Token":
                      (_b = session.csrfToken) !== null && _b !== void 0
                        ? _b
                        : "",
                    "Idempotency-Key":
                      (_c = requestHeaders["Idempotency-Key"]) !== null &&
                      _c !== void 0
                        ? _c
          ...
          case 10:
            ...
            throw lastError !== null && lastError !== void 0
              ? lastError
              : new Error("Orange request failed");
        }
      });
    });
  };
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            if (!forceLogin) {
              cached =
                (_a = this.session) !== null && _a !== void 0
                  ? _a
                  : this.loadSession();
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          ...
          case 1:
            ...
            csrfToken =
              (_a = this.extractCsrfToken(loginPage)) !== null && _a !== void 0
                ? _a
          ...
          case 2:
            ...
            if (loginResponse.status < 200 || loginResponse.status >= 300) {
              throw new Error(
                "Orange login failed with status ".concat(loginResponse.status),
              );
            }
            session = this.captureSession(loginResponse, initialSession);
            session.csrfToken =
              (_b = this.extractCsrfToken(loginResponse)) !== null &&
              _b !== void 0
                ? _b
                : csrfToken;
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          ...
          case 1:
            ...
            if (response.status < 200 || response.status >= 300) {
              throw new Error(
                "Orange refresh failed with status ".concat(response.status),
              );
            }
            this.captureSession(response, session);
            session.csrfToken =
              (_b = this.extractCsrfToken(response)) !== null && _b !== void 0
                ? _b
                : session.csrfToken;
            this.session = this.ensureExpiresAt(session);
            this.persistSession(this.session);
  ...
  OrangeProvider.prototype.captureSession = function (response, existing) {
    ...
    for (
      var _i = 0, _d = this.getSetCookieHeaders(response);
      _i < _d.length;
      _i++
    ) {
      var cookie = _d[_i];
    ...
    session.csrfToken =
      (_a = this.extractCsrfToken(response)) !== null && _a !== void 0
        ? _a
        : session.csrfToken;
    session.expiresAt =
      (_c =
        (_b = this.getEarliestCookieExpiry(session)) !== null && _b !== void 0
          ? _b
          : session.expiresAt) !== null && _c !== void 0
        ? _c
  ...
  OrangeProvider.prototype.parseSetCookie = function (header) {
    var _a = header.split(";").map(function (part) {
        return part.trim();
      }),
      pair = _a[0],
      attributes = _a.slice(1);
  ...
  OrangeProvider.prototype.getSetCookieHeaders = function (response) {
    ...
    var value =
      (_a = headers["set-cookie"]) !== null && _a !== void 0
        ? _a
        : headers["Set-Cookie"];
    if (!value) {
      return [];
  ...
  OrangeProvider.prototype.extractCsrfToken = function (response) {
    ...
    var headers = response.headers;
    var headerToken =
      (_a = headers["x-csrf-token"]) !== null && _a !== void 0
        ? _a
    ...
    var metaMatch = html.match(
      /<meta[^>]+name=["']csrf-token["'][^>]+content=["']([^"']+)["']/i,
    );
    var inputMatch = html.match(
      /<input[^>]+name=["'](?:_csrf|csrf_token|csrf)["'][^>]+value=["']([^"']+)["']/i,
    );
    var reversedInputMatch = html.match(
      /<input[^>]+value=["']([^"']+)["'][^>]+name=["'](?:_csrf|csrf_token|csrf)["']/i,
    );
    return (_c =
      (_b =
        metaMatch === null || metaMatch === void 0 ? void 0 : metaMatch[1]) !==
        null && _b !== void 0
        ? _b
        : inputMatch === null || inputMatch === void 0
          ? void 0
          : inputMatch[1]) !== null && _c !== void 0
      ? _c
      : reversedInputMatch === null || reversedInputMatch === void 0
        ? void 0
        : reversedInputMatch[1];
  };
  ...
  OrangeProvider.prototype.isSessionExpiredResponse = function (response) {
    ...
    var headers = response.headers;
    var location =
      (_a = headers["location"]) !== null && _a !== void 0
        ? _a
        : headers["Location"];
    return Boolean(
      location === null || location === void 0
        ? void 0
        : location.includes(this.config.loginPath),
    );
  };
  ...
  OrangeProvider.prototype.getRequestReference = function (request, operation) {
    ...
    return (_a = data === null || data === void 0 ? void 0 : data.reference) !==
      null && _a !== void 0
      ? _a
  ...
  OrangeProvider.prototype.formatPath = function (template, reference) {
    return template.includes(":reference")
      ...
      : ""
          .concat(template.replace(/\/$/, ""), "/")
          .concat(encodeURIComponent(reference));
  };
