...
export function handleSummary(data) {
  ...
  console.log("╠══════════════════════════════════════════════════════════╣");
  console.log(
    `║  Total Requests : ${String(m.http_reqs?.values?.count ?? 0).padEnd(39)}║`,
  );
  console.log(
    `║  Peak Throughput: ${String((m.http_reqs?.values?.rate ?? 0).toFixed(1) + " req/s").padEnd(39)}║`,
  );
  console.log("╠══════════════════════════════════════════════════════════╣");
  console.log(
    `║  P95 latency    : ${String((dur?.["p(95)"] ?? 0).toFixed(2) + " ms").padEnd(39)}║`,
  );
  console.log(
    `║  P99 latency    : ${String((dur?.["p(99)"] ?? 0).toFixed(2) + " ms").padEnd(39)}║`,
  );
  console.log(
    `║  Max latency    : ${String((dur?.max ?? 0).toFixed(2) + " ms").padEnd(39)}║`,
  );
  console.log("╠══════════════════════════════════════════════════════════╣");
  console.log(
    `║  Error Rate     : ${String(((m.stress_error_rate?.values?.rate ?? 0) * 100).toFixed(2) + "%").padEnd(39)}║`,
  );
  console.log(
    `║  Timeouts       : ${String(m.stress_timeout_count?.values?.count ?? 0).padEnd(39)}║`,
  );
  console.log("╚══════════════════════════════════════════════════════════╝\n");
